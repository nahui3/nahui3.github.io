...
3. **Применение дельты**
   - При получении дельты и опубликованного манифеста — применение дельты к предыдущему состоянию (или к пустому при холодном старте), кеширование опубликованного манифеста. Обновление локального дерева (добавление, изменение, удаление узлов по id/пути). Перерисовка UI по манифесту и содержимому файлов.
