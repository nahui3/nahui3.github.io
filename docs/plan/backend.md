...
- **Фича** — небольшой проект со своим манифестом и набором файлов-узлов. Узел (файл в фиче): **id** (UUID от пути к файлу), **name** (имя файла), **hash** (content-hash). Иерархия задаётся манифестом (дерево папок и файлов).
