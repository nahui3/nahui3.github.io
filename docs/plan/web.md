...
3. **Применение дельты**
   - При получении дельты и опубликованного манифеста — применение дельты к предыдущему состоянию (или к пустому при холодном старте), кеширование манифеста. Обновление state (useState/useReducer) и перерисовка.
